<template>
  <div role="group" class="form-group">
    <label :for="id" class="d-block">{{title}}</label>

    <div class="audit-search-card-list">
      <RemovableTextField
        :id="id"
...
<script>
import RemovableTextField from './RemovableTextField.vue';

export default {
  props: ['title', 'field', 'module', 'id'],
  components: {
    RemovableTextField,
  },
  computed: {
